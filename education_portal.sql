...
INSERT INTO `categories` VALUES (1,'Дизайн','Курсы по веб-дизайну, UI/UX, графическому дизайну','palette'),(2,'Игровая разработка','Создание игр, геймдизайн, игровые движки','gamepad'),(3,'Программирование','Веб-разработка, мобильные приложения, алгоритмы','code'),(4,'3D Моделирование','Blender, Maya, ZBrush, анимация','cube'),(5,'Звуковой дизайн','Создание музыки и звуковых эффектов для игр','music');
...
INSERT INTO `users` VALUES (1,'admin','admin@example.com','scrypt:32768:8:1$V2C2e4CQrQvB7HpK$8a5c7f3b1e9d2c4a6b8c0d2e4f6a8b0c2d4e6f8a0b2c4d6e8f0a2b4c6d8e0f2a4c6e8b0d2f4a6c8e0','Администратор Системы','default_avatar.png',1,1,'2025-12-10 21:22:54');
...
-- Dump completed on 2025-12-11  1:07:27
